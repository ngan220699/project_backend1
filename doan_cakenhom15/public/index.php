    ...
    <div class="container">
        <div class="row our_chef_inner">
            ...
            <div class="col-lg-3 col-6">
                <div class="chef_item">
                    <div class="chef_img">
                        <img class="img-fluid" src="img/chef/chef-2.jpg" alt="" style="height: 236px;">
                        <ul class="list_style">
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="l_news_image">
                    <div class="l_news_img">
                        <img class="img-fluid" src="./img/cake-feature/<?= Product::getProduct_ByID($getLatestReview[0]['product_id'])['pro_image'] ?>" alt="" style="height: 350px;">
                    </div>
